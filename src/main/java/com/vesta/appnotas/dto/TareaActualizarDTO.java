...
public class TareaActualizarDTO {
    ...
    public TareaActualizarDTO(Integer idCategoriaTarea, Integer idUsuario, String titulo, String descripcion, LocalDate fechaInicio,
                         LocalDate fechaFinalizacion, Integer idTarea) {
